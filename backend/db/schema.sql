...
CREATE TABLE IF NOT EXISTS herbs (
  ...
  action_text_zh      TEXT,          -- 功能 (công năng)
  indication_text_zh  TEXT,          -- 主治 (chủ trị)
  dose_text_zh        TEXT,
  dose_min_g          DECIMAL(6,2),
  dose_max_g          DECIMAL(6,2),
  caution_text_zh     TEXT,          -- 使用注意 (kiêng kỵ)

  is_active           BOOLEAN DEFAULT TRUE,
  updated_at          TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,

  FULLTEXT INDEX ft_herbs_search (name_zh, name_zh_traditional, name_vi, pinyin, action_text_zh, indication_text_zh)
