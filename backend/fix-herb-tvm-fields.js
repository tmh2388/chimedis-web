...
import { buildZhLookup } from './tcm-vocabulary.js';

// Tra theo zh THẬT lẫn mã thô còn sót (WEI_HAN kiểu cũ) — đọc từ
// backend/data/tcm-vocabulary.json, nguồn chân lý DUY NHẤT dùng chung với
// import-herbal-sheets.js/import-acupoint-sheets.js/frontend search (thay
// cho việc file này tự khai lại 1 bản TEMPERATURE/TASTE/MERIDIAN riêng —
// đúng kiểu kiến trúc từng gây bug TASTE_LABELS sai Hán Việt, xem
// project_chimedis_translation_qa).
const lookupTemperature = buildZhLookup('temperature');
const lookupTaste = buildZhLookup('taste');
const lookupMeridian = buildZhLookup('meridian_organ');
